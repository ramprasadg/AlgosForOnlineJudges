 ...
 *
 * <p>
 * You have 4 types of lego blocks, of sizes given as (1 x 1 x 1), (1 x 1 x 2), (1 x 1 x 3), and (1
 * x 1 x 4). Assume that you have an infinite number of blocks of each type. Using these blocks, you
 * want to make a wall of height N and width M. The wall should not have any holes in it. The wall
 * you build should be one solid structure. A solid structure can be interpreted in one of the
 * following ways: (1)It should not be possible to separate the wall along any vertical line without
 * cutting any lego block used to build the wall. (2)You cannot make a vertical cut from top to
 ...
 *
 * <p>
 * Input Format The first line contains the number of test cases T. T test cases follow. Each case
 * contains two integers N and M. Constraints 1 <= T <= 100 1 <= N,M <= 1000
 *
 * <p>
 * Output Format Output T lines, one for each test case containing the number of ways to build the
 * wall. As the numbers can be very large, output the result modulo 1000000007.
 */
public class LegoBlocks {
    ...
    public static void main(String[] args) throws Exception {
        ...
        for (int i = 1; i <= MAX_COL; i++) {
            ...
            SingleRow[i] = singleRow(i - 1) + singleRow(i - 2) + singleRow(i - 3)
                    + singleRow(i - 4);
